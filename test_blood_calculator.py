...
# and will override previous memory if it sees a same name,
# so only the last was run
...
# OR, can put in one function with multiple calls
# =============================================================================
...
#     answer = hdl_analysis(45)
#     expected = "Borderline Low"
#     assert answer == expected  # if test failed here, func stops
#     # & will not run later tests
#     answer = hdl_analysis(15)
#     expected = "Low"
#     assert answer == expected
# =============================================================================

# Actually, should use a decorator: (import pytest first)

# the decorator started with @
# parametrize in pytest takes in two parameters: ("string", [list])
# will loop through the list, tells when the func starts and ends
# (runs b/f and after the function)
