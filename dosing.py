...
# Program Driver (kinda like the main function, the order you call all funcs)
def dose_amount():
...
def get_user_input():
    ...
    # instead of call all these functions, return the outputs!!!


# Calculations function
# (can be further break into unit conversion and calculation)
