...
def interface():
    ...
    while keep_running:
        ...
        print("9 - Quit")
        choice = int(input("Make a choice: "))  # to compare against 9 later
...
def chol_output(CHOL_value, CHOL_answer):
    print("The Cholesterol value of {} is considered {}".format(CHOL_value,
                                                                CHOL_answer))


if __name__ == "__main__":  # so that it doesn't run if a module is imported
    interface()
